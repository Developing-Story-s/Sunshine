...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        Log.v("Table Creation", "" + tableNameHashSet.isEmpty());
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertFalse("Error: More than one record returned from weather query", cursor.moveToFirst());
